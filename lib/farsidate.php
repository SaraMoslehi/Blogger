...
function jdate($type, $TZhours=0, $TZminute=0, $maket="now")				 
{ 
    ...
    { 
        ...
        { 
            ...
            case "D": 
                ...
                else if($result1=="Sun") $result1="یکشنبه"; 
...
function jmaketime($hour=0,$minute=0,$second=0,$jmonth=0,$jday=0,$jyear=0)				 
{ 
...
function mstart($month,$day,$year) 											///Find Day Begining Of Month 
{ 
    list( $jyear, $jmonth, $jday ) = gregorian_to_jalali($year, $month, $day); 
...
function lastday ($month,$day,$year)										//Find Number Of Days In This Month 
{ 
...
function monthname($month)													//translate number of month to name of month 
{ 
...
function Convertnumber2farsi($srting)										////here convert to  number in persian  
{ 
    $num0="&#1776;"; 
    $num1="&#1777;"; 
    $num2="&#1778;"; 
...
{ 
	...
	$TEMP = jalali_to_gregorian($year, $month, $day);
